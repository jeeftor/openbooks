...
<figure markdown>
![OpenBooks Light Mode](https://github.com/jeeftor/openbooks/blob/master/.github/home_v3.png?raw=true#only-light)
![OpenBooks Dark Mode](https://github.com/jeeftor/openbooks/blob/master/.github/home_v3_dark.png?raw=true#only-dark)
<figcaption>
    Quickly and easily 
